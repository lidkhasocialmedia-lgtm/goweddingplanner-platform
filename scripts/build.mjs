  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <a href="/recursos/catalogo-2026/">Descargar catálogo 2026</a>
...
<section class="section-sm section-sage">
  <div class="container section-heading">
    ...
    <div class="cta-actions"><a class="btn btn-primary" href="/contacto/" data-track="inline_cta">Solicitar una conversación</a><a class="btn btn-text" href="/recursos/catalogo-2026/">Descargar catálogo 2026 ↗</a></div>
  </div>
</section>`;
...
<section class="hero-home">
  <div class="container hero-grid">
    <div class="hero-copy">
      ...
      <div class="hero-actions"><a class="btn btn-primary" href="#solicitar-presupuesto" data-track="hero_cta">Consulta gratuita <span aria-hidden="true">↗</span></a><a class="btn btn-outline" href="/recursos/catalogo-2026/">Descargar catálogo 2026</a></div>
...
<section class="section"><div class="container photo-split"><div class="photo-split-photo"><img src="${readAsset('equipo-javier-andrea.webp')}" alt="Javier y Andrea, equipo de Go Wedding Planner" width="639" height="435"></div><div class="photo-split-copy"><div class="kicker kicker-light">Creamos bodas con alma</div><h2>Lo bonito necesita una estructura que lo sostenga.</h2><p>Somos Javier y Andrea, el alma creativa y organizativa detrás de Go Wedding Planner. Nuestra trayectoria comenzó hace más de una década, fusionando mundos aparentemente distintos pero complementarios: la arquitectura efímera y la gestión de grandes eventos.</p><p>Lo que empezó como una pasión compartida por el diseño y la excelencia logística se convirtió en nuestra vocación. Nos dimos cuenta de que el sector nupcial necesitaba un enfoque fresco, lejos de los paquetes estandarizados y las bodas en serie.</p><p>Desde la selección cromática de las flores hasta la iluminación perfecta para el baile, cada decisión se toma pensando en vosotros y en cómo queréis que se sientan vuestros invitados.</p><div class="hero-actions"><a class="btn btn-light" href="/contacto/">Conocernos en una conversación</a><a class="btn btn-light" href="/trabaja-con-nosotros/">Trabajar con nosotros ↗</a></div></div></div></section>
<section class="section"><div class="container team-story-grid"><div class="team-story-photo"><img src="${readAsset('equipo-retrato.webp')}" alt="Javier y Andrea durante una sesión de equipo" loading="lazy"></div><div><div class="kicker">Más de 50 historias</div><h2>Vuestra única tarea es celebrar el amor.</h2><p>Hemos tenido el honor de acompañar a más de 50 parejas en este viaje, transformando espacios en Navalcarnero, Móstoles, fincas históricas en Madrid y destinos soñados.</p><p>Nuestro enfoque es integral y profundamente personal. No solo organizamos proveedores; diseñamos experiencias, cuidamos los tiempos y protegemos vuestra paz mental cuando llega el día de la boda.</p><p>Creemos que una boda debe ser un reflejo auténtico de la pareja. No una copia de Pinterest, sino una celebración con decisiones que tengan sentido para vosotros.</p><a class="btn btn-text" href="/portfolio/">Ver historias reales ↗</a></div></div></section>
...
const portfolio = () => `${pageHero({ kicker: 'Portfolio', title: 'Historias, atmósferas y lugares con carácter.', description: 'Bodas reales, parejas felices y escenas que nos recuerdan por qué el detalle importa. El objetivo no es copiar una boda, sino descubrir qué os mueve a vosotros.', current: ['Portfolio'] })}
<section class="section"><div class="container portfolio-cases"><article class="portfolio-case"><div class="portfolio-case-image"><img src="${readAsset('espacio-boda-1526.webp')}" alt="Boda de Andrea y Jorge en Valencia" loading="lazy"></div><div class="portfolio-case-copy"><div class="stars" aria-label="Cinco estrellas">★★★★★</div><h2>Andrea & Jorge</h2><p>“Organizar una boda a 350 km de donde vivimos parecía imposible. El equipo de Go Wedding Planner lo hizo parecer fácil. Visitaron el venue por nosotros, coordinaron a los proveedores locales y nos acompañaron en cada decisión.”</p><div class="portfolio-meta">Julio 2024 · Valencia<br><span>Destination wedding</span></div></div></article><article class="portfolio-case portfolio-case-reverse"><div class="portfolio-case-image"><img src="${readAsset('espacio-boda-1514.webp')}" alt="Boda de Ana y Carlos en Getafe" loading="lazy"></div><div class="portfolio-case-copy"><div class="stars" aria-label="Cinco estrellas">★★★★★</div><h2>Ana & Carlos</h2><p>“Muy profesionales y atentos. Siempre estaban justo donde los necesitábamos. El día de la boda fue impecable gracias a su coordinación. No tuvimos que preocuparnos de nada.”</p><div class="portfolio-meta">Agosto 2024 · Getafe<br><span>Coordinación Día B</span></div></div></article><article class="portfolio-case portfolio-case-dark"><div class="portfolio-case-copy"><div class="kicker kicker-light">Laura & Miguel · Octubre 2024</div><h2>La mejor decisión que tomamos.</h2><div class="stars" aria-label="Cinco estrellas">★★★★★</div><p>“Al principio pensamos que un wedding planner era un lujo innecesario. Ahora sabemos que fue la mejor inversión. No solo nos ayudaron a negociar con proveedores, también nos ahorraron meses de estrés.”</p></div><div class="portfolio-case-detail"><span class="big-symbol">“</span><p>El valor de una boda bien acompañada se nota cuando vosotros podéis estar dentro de la historia, no gestionándola desde fuera.</p></div></article></div></section>
<section class="section section-paper"><div class="container"><div class="section-heading"><div><div class="kicker">Escenas para imaginar</div><h2>Una galería de gestos, lugares y momentos.</h2><p>La misma mirada puede vivir en una finca, un espacio histórico, una cena al aire libre o una pista de baile bajo las luces.</p></div></div><div class="portfolio-mosaic"><figure class="regional-photo regional-photo-1"><img src="${readAsset('boda-testimonio-00.webp')}" alt="Pareja entrando en una celebración en un espacio de piedra" loading="lazy"><figcaption><span>Entrar en la celebración</span><b>01</b></figcaption></figure><figure class="regional-photo regional-photo-2"><img src="${readAsset('boda-testimonio-01.webp')}" alt="Pareja celebrando frente a un edificio histórico" loading="lazy"><figcaption><span>Un lugar con carácter</span><b>02</b></figcaption></figure><figure class="regional-photo regional-photo-3"><img src="${readAsset('boda-testimonio-02.webp')}" alt="Pareja cortando la tarta al atardecer" loading="lazy"><figcaption><span>Los detalles que se recuerdan</span><b>03</b></figcaption></figure><figure class="regional-photo regional-photo-4"><img src="${readAsset('boda-testimonio-03.webp')}" alt="Pareja bailando bajo luces cálidas" loading="lazy"><figcaption><span>Cuando empieza la fiesta</span><b>04</b></figcaption></figure></div></div></section>
<section class="section"><div class="container"><div class="section-heading"><div><div class="kicker">Bodas reales e historias felices</div><h2>Historias que se quedan.</h2><p>Lucía y Javier, Elena y Carlos, y María y Pablo nos recuerdan que cada presupuesto, cada lugar y cada pareja pide una solución diferente.</p></div><a class="btn btn-text" href="/#solicitar-presupuesto">Hablar sobre vuestra boda ↗</a></div><div class="story-grid"><article class="story-card"><div class="story-card-image"><img src="${readAsset('boda-lucia-javier.webp')}" alt="Boda de Lucía y Javier en Navalcarnero" loading="lazy"></div><div class="story-card-body"><div class="stars" aria-label="Cinco estrellas">★★★★★</div><blockquote>“Nuestra boda en la Finca Las Tenadas fue exactamente como la soñamos.”</blockquote><p><strong>Lucía & Javier</strong><br><span>Junio 2024 · Navalcarnero</span></p></div></article><article class="story-card"><div class="story-card-image"><img src="${readAsset('boda-elena-carlos.webp')}" alt="Boda de Elena y Carlos en Móstoles" loading="lazy"></div><div class="story-card-body"><div class="stars" aria-label="Cinco estrellas">★★★★★</div><blockquote>“Su diseño creativo transformó completamente el espacio y todo fluyó.”</blockquote><p><strong>Elena & Carlos</strong><br><span>Septiembre 2024 · Móstoles</span></p></div></article><article class="story-card"><div class="story-card-image"><img src="${readAsset('boda-maria-pablo.webp')}" alt="Boda de María y Pablo en Arroyomolinos" loading="lazy"></div><div class="story-card-body"><div class="stars" aria-label="Cinco estrellas">★★★★★</div><blockquote>“Nos enseñaron exactamente en qué se gastaba cada euro.”</blockquote><p><strong>María & Pablo</strong><br><span>Mayo 2024 · Arroyomolinos</span></p></div></article></div></div></section>
