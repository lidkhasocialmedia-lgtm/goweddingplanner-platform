...
<section class="section section-paper"><div class="container catalog-band"><div><div class="kicker">Catálogo 2026</div><h2>Todo lo que podemos hacer por vuestra boda.</h2><p>Descargad el catálogo completo para conocer nuestras experiencias, alcances y formas de acompañamiento.</p></div><a class="btn btn-primary" href="/assets/catalogo-2026.pdf" download>Descargar catálogo 2026 ↗</a></div></section>
